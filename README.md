...
- "label": [int] Toxicity label generated by toxicity classification models.
   note: Note: 0 indicates non-toxic text, while 1 indicates toxic text.
